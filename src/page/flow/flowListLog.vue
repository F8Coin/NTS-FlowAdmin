<template>
    <div class="fillcontain">
        <search-item  :placeholderText="placeholderText" @showDialog="showAddFundDialog" @searchList="searchFlowLog" @exportData="exportData" @resetList="resetFlowLog" @onBatchDelMoney="onBatchDelMoney"></search-item>
    ...
    export default {
        data(){
            return {
                ...
                placeholderText: '请输入卫星SN或ICCID卡号'
            }
        },
        components:{
            SearchItem,
